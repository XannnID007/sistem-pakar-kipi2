...
@endif
    ...
    <input type="text" name="kode_gejala" class="form-control" value="{{ $kodeBaru }}" readonly>
        ...
        <div class="mb-3">
            <label for="nam_gejala" class="form-label">Nama Gejala</label>
            <input type="text" name="nama_gejala" id="nama_gejala" class="form-control" placeholder="Contoh: Ruam dan gatal di kulit" value="{{ old('nama') }}" required>
        </div>
