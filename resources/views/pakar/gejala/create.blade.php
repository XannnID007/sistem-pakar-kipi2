...
@section('page_title', 'Tambah Gejala')

@section('content')

    <div class="max-w-2xl mx-auto bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
        <h2 class="text-2xl font-bold text-slate-800 mb-8 pb-4 border-b border-slate-200">Tambah Gejala Baru</h2>
        ...
        <form action="{{ route('pakar.gejala.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-xs text-slate-500">Kode gejala ini dihasilkan secara otomatis oleh sistem dan tidak
                    dapat diubah.</p>
            </div>
