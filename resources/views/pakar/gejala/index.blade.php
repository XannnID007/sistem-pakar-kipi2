                ...
                <tr>
                    ...
                    <td class="text-center text-nowrap">
                        <div class="d-flex justify-content-center gap-1">
                            <a href="{{ route('pakar.gejala.edit', $gejala->kode_gejala) }}" class="btn btn-warning btn-sm px-2 py-1">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{ route('pakar.gejala.destroy', $gejala->kode_gejala) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus gejala ini?')">
                                @csrf
                                @method('DELETE')
