        ...
        <form action="{{ route('pakar.aturan.update', $aturan->id_aturan) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" max="1" name="mb" id="mb"
                    class="form-control @error('mb') is-invalid @enderror" value="{{ old('mb', $aturan->mb) }}" required>
                @error('mb')
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" max="1" name="md" id="md"
                    class="form-control @error('md') is-invalid @enderror" value="{{ old('md', $aturan->md) }}" required>
                @error('md')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
